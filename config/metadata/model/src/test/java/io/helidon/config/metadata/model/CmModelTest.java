    ...
    void testFromJson() {
        ...
        assertThat(actual.modules(), is(hasItem(allOf(
                ...
                hasProperty("types", CmModule::types, is(hasItem(allOf(List.of(
                        ...
                        hasProperty("producers", CmType::producers, is(hasItems(
                                "com.acme.AcmeConfig#create(io.helidon.config.Config)",
                        ...
                        hasProperty("options", CmType::options, is(hasItem(allOf(List.of(
                                ...
                                hasProperty("allowedValues", CmOption::allowedValues, is(allOf(
                                        hasItem(allOf(
                                                ...
                                                hasProperty("description", CmAllowedValue::description, is(Optional.of("mode 1")))
                                        )),
                                        hasItem(allOf(
                                                hasProperty("value", CmAllowedValue::value, is("MODE2")),
                                                hasProperty("description", CmAllowedValue::description, is(Optional.of("mode 2")))
                                        )),
                                        hasItem(allOf(
                                                hasProperty("value", CmAllowedValue::value, is("MODE3")),
                                                hasProperty("description", CmAllowedValue::description, is(Optional.of("mode 3")))
                                        ))
                                )))
                        )))))
                )))))
