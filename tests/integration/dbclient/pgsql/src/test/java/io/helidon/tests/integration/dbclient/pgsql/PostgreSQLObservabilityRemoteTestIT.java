...
@TestProcesses
@Testing.Test
final class PostgreSQLObservabilityRemoteTestIT implements HttpObservabilityTest {

    @Container
    static final GenericContainer<?> CONTAINER = PostgreSQLTestContainer.CONTAINER;

    @TestProcess
    static final ProcessRunner PROCESS_RUNNER = PostgreSQLRemoteTest.PROCESS_RUNNER;
