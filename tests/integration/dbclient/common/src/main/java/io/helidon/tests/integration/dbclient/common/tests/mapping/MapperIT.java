...
public class MapperIT extends AbstractIT {
    ...
    public void testInsertWithOrderMapping() {
        ...
        try (DbExecute exec = DB_CLIENT.execute()) {
            long result = exec.createNamedInsert("insert-pokemon-order-arg-rev")
    ...
    public void testInsertWithNamedMapping() {
        ...
        try (DbExecute exec = DB_CLIENT.execute()) {
            long result = exec.createNamedInsert("insert-pokemon-named-arg")
                              .namedParam(pokemon)
                              .execute();
            verifyInsertPokemon(result, pokemon);
        }
    ...
    public void testUpdateWithOrderMapping() {
        ...
        try (DbExecute exec = DB_CLIENT.execute()) {
            long result = exec.createNamedUpdate("update-pokemon-order-arg")
                              .indexedParam(pokemon)
                              .execute();
    ...
    public void testUpdateWithNamedMapping() {
        ...
        try (DbExecute exec = DB_CLIENT.execute()) {
            long result = exec.createNamedUpdate("update-pokemon-named-arg")
                              .namedParam(pokemon)
                              .execute();
            verifyUpdatePokemon(result, pokemon);
        }
    ...
    public void testGetWithMapping() {
        try (DbExecute exec = DB_CLIENT.execute()) {
            Optional<DbRow> maybeRow = exec.createNamedGet("select-pokemon-named-arg")
