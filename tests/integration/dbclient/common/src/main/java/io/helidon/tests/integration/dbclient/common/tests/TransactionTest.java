...
public interface TransactionTest extends TransactionTests.TxDeleteTest,
     ...
     */
    final class TestImpl extends AbstractTest implements TransactionTest {
         ...
         *
         * @param insertHandler insert handler
         */
        public TestImpl(InsertHandler insertHandler) {
        ...
        public void testCreateNamedQueryNamedAndOrderArgsWithoutArgs() {
            try {
                ...
                throw new AssertionError(
                        "Execution of query with both named and ordered parameters without passing any shall fail.");
            } catch (Throwable ex) {
                // expected
            }
        }
        ...
        public void testCreateNamedQueryNamedAndOrderArgsWithArgs() {
            try {
                ...
                tx.commit();
                throw new AssertionError(
                        "Execution of query with both named and ordered parameters without passing them shall fail"
                        + ".");
            } catch (Throwable ex) {
                // expected
            }
        ...
        public void testCreateNamedQueryNamedArgsSetOrderArg() {
            try {
                ...
                tx.commit();
                throw new AssertionError(
                        "Execution of query with named parameter with passing ordered parameter value shall fail.");
            } catch (Throwable ex) {
                // expected
            }
        }
        ...
        public void testCreateNamedQueryOrderArgsSetNamedArg() {
            try {
                ...
                tx.commit();
                throw new AssertionError(
                        "Execution of query with ordered parameter with passing named parameter value shall fail.");
            } catch (Throwable ex) {
                // expected
            }
        }
        ...
        public void testInsertNamedArgsReturnedKeys() throws Exception {
            ...
            try (DbResultDml result = tx.createNamedInsert("insert-match")
                ...
                assertThat(result.result(), equalTo(1L));
                assertThat(keys, hasSize(1));
                insertHandler.testInsertNamedArgsReturnedKeys(keys.getFirst());
                tx.commit();
            } catch (Exception ex) {
                tx.rollback();
            }
        ...
        public void testInsertNamedArgsReturnedColumns() throws Exception {
            ...
            try (DbResultDml result = tx.createNamedInsert("insert-match")
                ...
                assertThat(result.result(), equalTo(1L));
                assertThat(keys, hasSize(1));
                insertHandler.testInsertNamedArgsReturnedColumns(keys.getFirst());
                tx.commit();
            } catch (Exception ex) {
                tx.rollback();
            }
