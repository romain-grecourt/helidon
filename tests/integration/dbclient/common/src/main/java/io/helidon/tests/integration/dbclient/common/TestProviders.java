...
abstract class TestProviders {

    /**
     * Mapper provider.
     */
    public static class MapperProviderImpl implements MapperProvider {
        ...
        public ProviderResponse mapper(Class<?> sourceClass, Class<?> targetClass, String qualifier) {
            if (Number.class.isAssignableFrom(sourceClass)) {
                Mapper<Number, ?> mapper = switch (targetClass.getName()) {
     ...
     */
    public static final class DbMapperProviderImpl implements DbMapperProvider {
