...
public class MicrometerSimplePrometheusTest {
    ...
    private static final HttpMediaType TEXT_SPECIAL = HttpMediaType.create(
            MediaTypes.create(MediaTypes.TEXT_PLAIN.type(), "special"));

    private MicrometerFeature micrometerSupport;
    ...
    static void prepAll() {
        MeterRegistryFactory factory =
                MeterRegistryFactory.builder().enrollRegistry(registry, req -> {
