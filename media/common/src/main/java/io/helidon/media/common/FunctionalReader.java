...
import io.helidon.media.common.MediaSupport.ReaderFunction;
 ...
 */
public final class FunctionalReader<T> implements Reader<T> {

    private final OperatorPredicate<ReaderContext> predicate;
    private final ReaderFunction<T> function;
     ...
     */
    FunctionalReader(OperatorPredicate<ReaderContext> predicate, ReaderFunction<T> function) {
    ...
    public <U extends T> Single<U> read(Flow.Publisher<DataChunk> publisher,
