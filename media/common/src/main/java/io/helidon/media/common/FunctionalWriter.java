...
import io.helidon.media.common.MediaSupport.WriterFunction;
...
public final class FunctionalWriter<T> implements Writer<T> {
     ...
     */
    FunctionalWriter(OperatorPredicate<WriterContext> predicate, WriterFunction<T> function) {
    ...
    public <U extends T> Flow.Publisher<DataChunk> write(Single<U> single,
                                                         GenericType<U> type,
