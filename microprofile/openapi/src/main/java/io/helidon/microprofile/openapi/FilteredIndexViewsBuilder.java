...
/**
 * List of filtered index views, one for each JAX-RS application, sorted by the Application class name to help
...
class FilteredIndexViewsBuilder {
    ...
    private static class FilteringOpenApiConfigImpl extends OpenApiConfigDelegate {

        private final Set<String> classesToExclude;

        FilteringOpenApiConfigImpl(OpenApiConfig config, Set<String> classesToExclude) {
            super(config);
