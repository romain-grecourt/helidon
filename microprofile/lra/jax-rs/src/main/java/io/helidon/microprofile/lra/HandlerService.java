...
class HandlerService {
    ...
    private static final Map<String, AnnotationHandler.HandlerMaker> HANDLER_SUPPLIERS =
            Map.of(
                    ...
                    Leave.class.getName(), (a, c, i, p) -> new LeaveAnnotationHandler(c, p),
                    Status.class.getName(), (a, c, i, p) -> new NoopAnnotationHandler(p),
                    AfterLRA.class.getName(), (a, c, i, p) -> new NoopAnnotationHandler(p)
            );
    ...
    HandlerService(CoordinatorClient coordinatorClient,
                   ...
                   @ConfigProperty(name = "mp.lra.propagation.active", defaultValue = "true") boolean propagate) {
