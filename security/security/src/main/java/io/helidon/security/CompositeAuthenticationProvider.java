...
final class CompositeAuthenticationProvider implements AuthenticationProvider {
    ...
    private AtnResponse invokeProvider(AtnResponse previous, Atn nextProviderConfig, ProviderRequest providerRequest) {
    ...
    private void checkAtnResponseStatus(CompositeProviderFlag flag,
        ...
        if (!flag.isValid(status)) {
            ...
            switch (status) {
                ...
                default -> throw new AsyncAtnException(response);
            }
        }
    }
