 ...
 */
public final class PrometheusFeature extends HelidonFeatureSupport {

    /**
     * Standard path of Prometheus client resource: {@code /metrics}.
     */
    private static final String DEFAULT_PATH = "/metrics";
    private static final System.Logger LOGGER = System.getLogger(PrometheusFeature.class.getName());
    ...
    private PrometheusFeature(Builder builder) {
     ...
     * @see #builder()
     */
    public static PrometheusFeature create(CollectorRegistry collectorRegistry) {
     ...
     * @see #builder()
     */
    public static PrometheusFeature create() {
        return create(null);
    }
    ...
    /**
     * A builder of {@link PrometheusFeature}.
     */
    public static final class Builder extends HelidonFeatureSupport.Builder<Builder, PrometheusFeature> {
        ...
        @Override
        public PrometheusFeature build() {
            return new PrometheusFeature(this);
        }
