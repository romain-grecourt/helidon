...
public class MainTest {
    ...
    static void setup(WebServer.Builder builder) {
        Main.firstRouting(builder);
        Main.mediaReader(builder);
        Main.advancedRouting(builder);
        Main.organiseCode(builder);
        Main.routingAsFilter(builder);
        Main.parametersAndHeaders(builder);
        Main.errorHandling(builder);
        Main.readContentEntity(builder);
        Main.supports(builder);
    }
