...
<dependencies>
    <dependency>
        <groupId>io.helidon.se.config</groupId>
        <artifactId>helidon-se-config-yaml</artifactId>
    </dependency>
</dependencies>
----
...
<dependencies>
    <dependency>
        <groupId>io.helidon.se.config</groupId>
        <artifactId>helidon-se-config-hocon</artifactId>
    </dependency>
</dependencies>
----
...
<dependencies>
    <dependency>
        <groupId>io.helidon.se.config</groupId>
        <artifactId>helidon-se-config-etcd</artifactId>
    </dependency>
</dependencies>
----
...
<dependencies>
    <dependency>
        <groupId>io.helidon.se.config</groupId>
        <artifactId>helidon-se-config-git</artifactId>
    </dependency>
</dependencies>
----
