...
package io.helidon.se.webserver.metrics;
...
import io.helidon.se.metrics.HelidonMetric;
import io.helidon.se.metrics.Registry;
...
public final class MetricsSupport implements Service {
    ...
    private MetricsSupport(Builder builder) {
        this.rf = RegistryFactory.createSeFactory(builder.config);
