...
abstract class JdbcStatement<S extends DbStatement<S>, R> extends AbstractStatement<S, R> {
    ...
    static final class Parser {
        ...
        private enum State {
            ...
            STRING,               // SQL string processing after 1st APOSTROPHE was received
            COLON,                // Symbolic name processing after opening COLON (colon) was received
            PARAMETER,            // Symbolic name processing after 1st LETTER or later LETTER
                                  // or NUMBER of parameter name was received
            MULTILN_COMMENT_BG,   // Multiline comment processing after opening slash was received from the "/*" sequence
            MULTILN_COMMENT_END,  // Multiline comment processing after closing star was received from the "*/" sequence
            MULTILN_COMMENT,      // Multiline comment processing of the comment itself
            SINGLELN_COMMENT_BG,  // Single line comment processing after opening dash was received from the "--" sequence
            SINGLELN_COMMENT_END, // Single line comment processing after closing CR was received from the CR LF sequence
        ...
        private static final Action[][] ACTION = {
            // Actions performed on transitions from STATEMENT state
            {
                ...
                Parser::copyChar,  // DASH: copy character to output, no matter whether it's comment or not
                Parser::copyChar,  // SLASH: copy character to output, no matter whether it's comment or not
           ...
           // Actions performed on transitions from COLON state
           {
               ...
               Parser::addColonAndCopyChar, // DASH: not a parameter, add delayed colon and copy current statement character
                                            //       to output, no matter whether it's comment or not
