 ...
 * with {@link DbClient.Builder#addService(DbClientService)}.
 ...
 *
 * @see DbClientMetricBuilder#statementTypes(DbStatementType...)
...
public class DbClientMetrics {
     ...
     * with {@link DbClient.Builder#addService(java.util.function.Supplier)}.
     *
