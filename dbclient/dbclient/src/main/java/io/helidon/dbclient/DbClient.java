...
public interface DbClient {
    /**
     * Qualifier used for mapping using {@link MapperManager#map(Object, Class, Class, String...)}.
     */
    String MAPPING_QUALIFIER = "dbclient";

    /**
     * Get a database transaction executor.
     *
    ...
    /**
     * Create Helidon database handler builder.
     * <p>Database driver is loaded as SPI provider which implements {@link DbClientProvider} interface.
    ...
    static Builder builder() {
        ...
        if (null == theSource) {
            throw new DbClientException(
                    "No DbSource defined on classpath/module path."
                            + " An implementation of io.helidon.dbclient.spi.DbSource is required to access a DB");
        }
