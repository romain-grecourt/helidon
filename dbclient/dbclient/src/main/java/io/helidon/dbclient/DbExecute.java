...
public interface DbExecute extends AutoCloseable {
    ...
    /**
     * Create and delete statement using a named statement.
     *
     * @param statementName the name of the statement
     * @return database statement that can delete data
     */
     ...
     * This connection instance is being used to execute all statements in current database executor context.
     *
